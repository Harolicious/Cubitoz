...
def createScene(rootNode):
        ...
        #cubito
                ...
                cubito.addObject('BoxROI', name='boxROI', box=[-13, 0, -13,  13, 2, 13], drawBoxes=True, position="@tetras.rest_position", tetrahedra="@container.tetrahedra")
                ...
                # modelSubTopo1.addObject('YoungModulusEquality', template='Vec3', name='actuator', maxYoungVariationRatio=0.02, minYoung=10)
		...
		#cubito/cavity
                ...
                SPA = cavity.addObject('SurfacePressureEquality', triangles='@topo.triangles', eqPressure=7000 * PSI)
