...
def createScene(rootNode):
        ...
        #cubito
                ...
                boxROIStiffness = cubito.addObject('BoxROI', name='boxROIStiffness', box=[-13, 17.5, -13,  13, 20, 13], drawBoxes=True, position="@tetras.rest_position", tetrahedra="@container.tetrahedra")
